...
export const MERV_GUIDE: Record<PreferredMerv, MervGuide> = {
  "8": {
    ...
    strength: 1,
    note: "The workhorse rating. Everyday dust with low resistance — a safe start on older systems and most modern ones.",
  ...
  "11": {
    ...
    strength: 3,
    note: "The usual upgrade when fur, spring pollen, or city air is in the mix. Adds more resistance than MERV 8 — fine for most modern units; confirm capacity on older equipment.",
    pickTitle: "Pets",
  ...
  "13": {
    ...
    strength: 5,
    note: "Hospital-adjacent capture for home HVAC. Highest resistance of our ratings — modern units usually handle it; older systems may need MERV 8 or 11 instead. Check the manual.",
    pickTitle: "Allergies",
  ...
  carbon: {
    ...
    strength: 1,
    note: "Activated carbon grabs gases that a pleat alone will not. Particle rating stays MERV 8, so resistance stays in the everyday range.",
