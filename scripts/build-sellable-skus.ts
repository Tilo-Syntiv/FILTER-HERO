...
const payload = {
  ...
  note: "Wholesale cost source for 299 size × MERV lines. Keep filter-catalog.json intact. VITE_FULL_CATALOG=true in .env sells every archived size and carbon; false restricts the shop to this list.",
